...
print('gal_en_XLM-R: model training beginning...')
...
gal_model = AutoModelForTokenClassification.from_pretrained(
    'liaad/srl-en_xlmr-base', num_labels=gal_num_labels, id2label=gal_id2label, label2id=gal_label2id
)

# Set Galician model parameters & create Trainer()
gal_training_args = TrainingArguments(
    output_dir='gal_en_XLM-R/',
    learning_rate=2e-5,
...
print('gal_en_XLM-R: model training complete')